...
function useNextLevelCategory(selectedCategory: CategoryType) {
  const [category, setCategory] = useState<CategoryType[]>();

  async function fetchCategory() {
    const resp = await fetch(
      `https://multi-account.sellernext.com/home/public/connector/profile/getCatrgoryNextLevel?target_marketplace=eyJtYXJrZXRwbGFjZSI6ImFsbCIsInNob3BfaWQiOm51bGx9&marketplace=twitter&next_level=${selectedCategory?.nextLevel}`,
      {
        headers: {
          appCode:
...
export default useNextLevelCategory;
